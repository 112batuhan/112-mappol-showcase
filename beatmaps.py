...
def get_pool():
    ...
    for line in content:
        ...
        if line == "-NM-": mod = "No Mod"
        elif line == "-HD-": mod = "Hidden"
        elif line == "-HR-": mod = "Hard Rock"
        elif line == "-DT-": mod = "Double Time"
        elif line == "-FM-": mod = "Free Mod"
        elif line == "-TB-": mod = "Tie Breaker"
        else:
